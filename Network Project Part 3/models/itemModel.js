...
const itemSchema = new mongoose.Schema({
    ...
    totalOffers: { type: Number, default: 0 }, // Default value set to 0
    active: { type: Boolean, default: true }, // Default value set to true
...
/* To test validation of itemSchema
...
item.validate()
.then(() => console.log('Item is valid'))
